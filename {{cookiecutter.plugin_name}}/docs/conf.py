#!/usr/bin/env python
#
# aprsd_nearest_plugin documentation build configuration file, created by
...
version = aprsd_nearest_plugin.__version__
# The full version, including alpha/beta/rc tags.
release = aprsd_nearest_plugin.__version__
